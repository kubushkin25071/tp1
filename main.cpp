...
void display_main_menu() {
    //system("cls");
    cout << "\n--- Главное меню ---" << endl;
    cout << "1 - Добавить новый инструмент в конец" << endl;
    cout << "2 - Добавить новый инструмент в начало" << endl;
    cout << "3 - Удалить инструмент по индексу" << endl;
    cout << "4 - Удалить инструмент c конца" << endl;
    cout << "5 - Удалить инструмент c начала" << endl;
    cout << "6 - Редактировать инструмент" << endl;
    cout << "7 - Отобразить список инструментов" << endl;
